...
public class BoxInviteService {
    ...
    public BoxJoinResponse joinBoxByInviteLink(String code, User user) {
        ...
        // 2. 모임에 가입
        boxMemberApplicationService.joinGroupBox(boxService.getReferenceById(boxInviteDto.getBoxId()), user);
