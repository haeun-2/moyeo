package com.mo.moyeo.domain.box.member.controller;
...
import com.mo.moyeo.domain.box.member.service.BoxMemberApplicationService;
...
public class BoxMemberController {
    ...
    private final BoxMemberApplicationService boxMemberApplicationService;
    ...
    public ResponseEntity<List<BoxMemberResponse>> getMemberList(@PathVariable Long boxId) {
        List<BoxMemberResponse> response = boxMemberApplicationService.getGroupBoxMemberList(boxId);
    ...
    public ResponseEntity<Void> updateMemberPermissions(
        ...
        boxMemberApplicationService.updateGroupBoxMemberPermissions(boxId, userDetails.getUser(), requests);
    ...
    public ResponseEntity<Void> leaveGroupBox(@PathVariable Long boxId, @AuthenticationPrincipal CustomUserDetails userDetails) {
        boxMemberApplicationService.leaveGroupBox(boxId, userDetails.getUser());
        return ResponseEntity.ok().build();
    }
